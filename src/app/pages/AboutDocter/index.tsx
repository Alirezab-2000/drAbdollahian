      ...
      <div className={styles.container}>
        ...
        <div className={styles.content_box}>
          ...
          <DrInformationMap
            text={"سوابق تحصیلی"}
            childTexts={[
              "تخصص قلب و عروق - دانشگاه علوم پزشکی مازندران [90 - 1386] ",
          ...
          <DrInformationMap
            ...
            childTexts={[
              ...
              "همکاری با هلال احمر به عنوان پزشک کاروان حج عمره",
              "متخصص قلب و بیمارستان 15 خرداد - مهدیشهر - سمنان [از دی 1390] ",
              "به عنوان ضریب k",
              "خدمت در بیمارستان صحرایی فولاد محله",
              "برگزاری کلاسهای اموزشی در بیمارستان",
              ...
              "همکاری با مجمع خیرین سلامت مهدیشهر",
            ]}
          />
          ...
          <DrInformationMap
            ...
            childTexts={[
              ...
              "سایر مهارت ها",
              "1- فن بیان و کوشایی",
              `2- مسئولیت پذیری و تعهد`,
              "3-  مهارت تدریس پویا و فعال",
              "4-  مهارت در ورزش کوهنوردی و سنگ نوردی و شنا",
              "5-  آشنا با شعر و ادبیات",
            ]}
          />
        </div>
      </div>
